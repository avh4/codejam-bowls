...
public class BowlProblemSolver {
    ...
    protected int solve(final String recipeInput) {
    ...
    private static String parseName(String recipe) {
        return recipe.split(" ")[0];
    }

    private static List<String> parseSubmixtures(String recipe) {
